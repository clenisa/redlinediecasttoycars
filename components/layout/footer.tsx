...
import { mockFooterMenu } from 'lib/mock-data';
import { Menu } from 'lib/shopify/types';

const SITE_NAME = process.env.SITE_NAME || 'Redline Diecast';
const COMPANY_NAME = process.env.COMPANY_NAME || 'Redline Diecast Toy Cars';
...
const footerLinks = {
  shop: [
    ...
    { title: 'Best Sellers', path: '/search/bestsellers' },
    { title: 'Limited Edition', path: '/search/limited-edition' },
  ],
  brands: [
    { title: 'Ferrari', path: '/search/ferrari' },
    { title: 'Lamborghini', path: '/search/lamborghini' },
    { title: 'Porsche', path: '/search/porsche' },
  ...
  return (
    <footer className="border-t border-neutral-100 bg-white dark:border-neutral-800 dark:bg-neutral-950">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="inline-flex items-center gap-2">
              ...
              <span className="text-xl font-light tracking-wide">DIECAST</span>
            </Link>
            <p className="mt-4 max-w-xs text-sm text-neutral-600 dark:text-neutral-400">
              Premium diecast model cars for collectors and enthusiasts. Every detail, precision crafted.
            </p>
            {/* Social Links */}
      ...
      <div className="border-t border-neutral-100 dark:border-neutral-800">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-4 py-6 text-xs text-neutral-500 dark:text-neutral-400 md:flex-row lg:px-8">
